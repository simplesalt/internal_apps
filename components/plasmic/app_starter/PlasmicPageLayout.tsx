...
// Plasmic Project: jqnNJsfntAQNhYdMtFP93i
// Component: W2M3x1bviXDF
...
import projectcss from "./plasmic.module.css"; // plasmic-import: jqnNJsfntAQNhYdMtFP93i/projectcss
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: W2M3x1bviXDF/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: Ne64h_XbmFNH/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: qKjxLoHWiqRQ/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__o1Tgj)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox___8YbS1)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg___32JRp)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__i5QFx)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section___8McO3)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
